...
Pod::Spec.new do |s|
  s.name             = "TabBarPicker"
  s.version          = "0.1.0"
  s.summary          = "A short description of TabBarPicker."
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/TabBarPicker"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Giuseppe Nucifora" => "me@giuseppenucifora.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/TabBarPicker.git", :tag => s.version.to_s }
